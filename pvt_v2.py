...
pretrain_dir ='./Models/pretrained'
if 1:
	cfg = dict(
		# pvt_v2_b0 = dict(
		# 	checkpoint = pretrain_dir + '/pvt_v2_b0.pth',
		#     builder  =  pvt_v2_b0,
		# ),
		# pvt_v2_b1 = dict(
		# 	checkpoint = pretrain_dir + '/pvt_v2_b1.pth',
		# 	builder  =  pvt_v2_b1,
		# ),
		# pvt_v2_b2 = dict(
		# 	checkpoint = pretrain_dir + '/pvt_v2_b2.pth',
		# 	builder  =  mit_b2,
		# ),
		# pvt_v2_b3 = dict(
		# 	checkpoint = pretrain_dir + '/pvt_v2_b3.pth',
		# 	builder  =  pvt_v2_b3,
		# ),
		pvt_v2_b4 = dict(
			checkpoint = pretrain_dir + '/pvt_v2_b4.pth',
			builder  =  pvt_v2_b4,
		),
		pvt_v2_b5 = dict(
			checkpoint = pretrain_dir + '/pvt_v2_b5.pth',
			builder  =  pvt_v2_b5,
		),
	)
